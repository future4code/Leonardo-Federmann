...
// Não foi especificado quais deveriam ser os roles dos usuários, motivo pelo qual criei os roles BEGINNER,
//INTERMEDIATE e CHEF. Portanto, todos os usuários serão considerados 'normais'.
